<nav class="navbar navbar-expand-lg navbar-light bg-light" style="position: -webkit-sticky;position: sticky;top:  0;left: 0px;z-index: 1; "  >
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent" style="background: #003478;">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a style="color: white;" class="nav-link" href="#">TRANG CHỦ <span class="sr-only">(current)</span></a>
      </li>
      ...
      <li class="nav-item dropdown">
       ...
       <li class="nav-item active">
        <a style="color: white;" class="nav-link" href="#">LIÊN HỆ<span class="sr-only">(current)</span></a>
      </li>
      
    </ul>
    <form class="form-inline my-2 my-lg-0" method="GET" action="search.php">
      <input class="form-control mr-sm-2" type="text" placeholder="Search"  name="ten">
